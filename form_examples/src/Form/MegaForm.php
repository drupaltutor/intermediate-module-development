...
class MegaForm extends FormBase {

  public function getFormId() {
    // Unique ID of the form
    return 'form_examples.mega_form';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['group_two']['birthdate'] = [
      ...
      '#default_value' => '2017-04-03',
    ];

    $form['group_two']['birthdate_2'] = [
      '#type' => 'datetime',
      '#title' => $this->t('Birth date again'),
    ...
    $form['group_two']['birthdate_3'] = [
      '#type' => 'datetime',
      '#title' => $this->t('Birth date with time'),
      '#default_value' => \Drupal\Core\Datetime\DrupalDateTime::createFromArray(
        [
          'year' => 2017,
          'month' => 04,
    ...
    $form['#attached']['library'][] = 'form_examples/mega-form';
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    $this->messenger()->addStatus($this->t('Thanks for submitting the form!'));
    dsm($form_state->getValues());
    dsm($form_state->getTriggeringElement());
    dsm($form_state->getValue('total'));
    dsm($form_state->getValue('secret_value'));
    dsm($form_state->getValue(['group_five', 'secret_value']));
